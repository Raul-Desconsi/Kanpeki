...
//?-------------------------------------------------------------------------------//
async function buscarKaizens(nome,filtro, cracha) {

  try {
    const response = await fetch('../api/get/kaizen/coletaKaizenPorUsuario.php', {
      method: 'POST',
...
const cracha = document.getElementById("cracha").textContent





const resposta =  await buscarKaizens(inputDePesquisa,filtroDePesquisa, cracha);
