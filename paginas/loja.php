                ...
                <form method="GET" action="">
                    <div class="mb-3">
                        <input type="text" name="search" class="form-control search-input"
                            placeholder="Buscar produtos..." value="<?php echo htmlspecialchars($searchTerm); ?>">
                    </div>
        ...
        <main class="main-content">
            ...
            <?php if (!empty($searchTerm)): ?>
                <div class="search-active">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            <h4><i class="fas fa-search"></i> Resultados para:
                                "<?php echo htmlspecialchars($searchTerm); ?>"</h4>
            ...
            <?php if (!empty($searchTerm) && empty($produtos)): ?>
                <div class="no-results">
                    ...
                    <p class="text-muted">Não encontramos resultados para
                        "<strong><?php echo htmlspecialchars($searchTerm); ?></strong>"</p>
                        ...
                        <?php foreach ($produtosPromocao as $promocao):
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="promo-card"
                                    onclick="window.location.href='#produto-<?php echo $promocao['id']; ?>'">
                                    <?php if (!empty($promocao['img'])): ?>
                                        <img src="<?php echo htmlspecialchars($promocao['img']); ?>"
                                            alt="<?php echo htmlspecialchars($promocao['nome']); ?>">
                                    <?php else: ?>
                                    ...
                                    <div>
                                        <span
                                            class="text-decoration-line-through"><?php echo number_format($promocao['preco'], 0, ',', '.'); ?>
                                            pts</span>
                                        <br>
                                        <strong><?php echo number_format($precoComDesconto, 0, ',', '.'); ?> pts</strong>
                                    </div>

                                    <button type="button" class="btn btn-light btn-sm mt-2 btn-adicionar-promo"
                                        data-id="<?php echo (int) $promocao['id']; ?>">
                        ...
                        <div class="col-lg-4 col-md-6" id="produto-<?php echo (int) $produto['id']; ?>">
                            <div class="card h-100 position-relative <?php echo $temDesconto ? 'card-destaque' : ''; ?>">
                                ...
                                <?php if (!empty($produto['img'])): ?>
                                    <img src="<?php echo htmlspecialchars($produto['img']); ?>" class="card-img-top"
                                    ...
                                    <div class="mt-auto">
                                        <?php if ($temDesconto): ?>
                                            <p class="card-text mb-1">
                                                <span
                                                    class="preco-original"><?php echo number_format($produto['preco'], 0, ',', '.'); ?>
                                                    pts</span>
                                        ...
                                        <?php else: ?>
                                            <p class="card-text">
                                                <strong
                                                    class="text-primary"><?php echo number_format($produto['preco'], 0, ',', '.'); ?>
                                                    pontos</strong>
                                            </p>
                                        <?php endif; ?>
                                        ...
                                        <?php else: ?>
                                            <button type="button" class="btn btn-primary btn-adicionar w-100 mt-2"
